...
with open(os.path.join(data_dir, 'jeux.csv'), 'w', newline='', encoding='latin-1') as f:
    writer = csv.writer(f)
...
with open(os.path.join(data_dir, 'plateformes.csv'), 'w', newline='', encoding='latin-1') as f:
    writer = csv.writer(f)
...
with open(os.path.join(data_dir, 'parties.csv'), 'w', newline='', encoding='latin-1') as f:
    writer = csv.writer(f)
...
with open(os.path.join(data_dir, 'achats.csv'), 'w', newline='', encoding='latin-1') as f:
    writer = csv.writer(f)
...
with open(os.path.join(data_dir, 'signalements.csv'), 'w', newline='', encoding='latin-1') as f:
    writer = csv.writer(f)
...
with open(os.path.join(data_dir, 'sanctions.csv'), 'w', newline='', encoding='latin-1') as f:
    writer = csv.writer(f)
...
# ============================================================
# ÉCRITURE DU SCRIPT SQL (création tables + BULK INSERT)
# ============================================================
sql_script = f"""
-- ============================================================
-- CRÉATION DE LA BASE ET DES TABLES
-- ============================================================
-- À exécuter dans SSMS sur la base de votre choix (ex. master ou une base dédiée)
...
-- ============================================================
-- BULK INSERT (chemins absolus vers les CSV)
-- ============================================================
...
WITH (FIELDTERMINATOR = ',', ROWTERMINATOR = '\\n', FIRSTROW = 2, CODEPAGE = '1252', KEEPIDENTITY);
...
print("Assure-toi que le service SQL Server a les droits de lecture sur le dossier data.")